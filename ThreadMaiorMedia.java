...
public class ThreadMaiorMedia extends Thread{
	...
	public ThreadMaiorMedia(int matriz[][], int primeiraLinha, int ultimaLinha, int primeiraColuna, int ultimaColuna, float media) {
		matrizThread = matriz;
